...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.CustomViewHolder> {
    ...
    public MainAdapter(ArrayList<MainData> dataList, Context context) {
    ...
    public void onBindViewHolder(@NonNull final CustomViewHolder customViewHolder, final int position) {
        ...
        Bitmap albumImage = getAlbumImage(context, Integer.parseInt((dataList.get(position)).getAlbumId()), 170);
